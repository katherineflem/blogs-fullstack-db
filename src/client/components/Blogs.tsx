                    ...
                    <article key={`blog-${blog.id}`} className="col-md-4">
                        <div className="card m-1 shadow">
                            <div className="card-body">
                                <img src="https://hips.hearstapps.com/del.h-cdn.co/assets/18/11/2048x1024/landscape-1520956952-chicken-tacos-horizontal.jpg?resize=1200:*" className="card-img-top mw-100 "></img>
